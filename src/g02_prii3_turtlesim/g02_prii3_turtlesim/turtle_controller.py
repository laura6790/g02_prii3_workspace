...
class TurtleController(Node):
    ...
    def generate_number_2_movements(self):
        """Genera los movimientos para dibujar un número 2 reconocible"""
        movements = []
        
        # NÚMERO 2 - Forma clásica
        movements.extend([
            (1.5, 0.0),    # Línea superior horizontal
            (0.0, -0.5),   # Iniciar curva suave
            (0.5, 0.0),    # Descender diagonalmente
            (0.0, -0.5),   # Continuar curva
            (0.5, 0.0),    # Seguir descendiendo
            (0.0, 1.0),    # Curva hacia la base
            (1.5, 0.0),    # Línea horizontal inferior
        ])
